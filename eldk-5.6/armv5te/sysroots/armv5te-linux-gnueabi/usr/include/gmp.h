...
#define __GMP_CC "arm-linux-gnueabi-gcc  -march=armv5te -marm -mthumb-interwork --sysroot=/opt/eldk/build/eldk-rel-v5.6-2014-11-19-8346b82-armv5te/tmp/sysroots/generic-armv5te"
#define __GMP_CFLAGS "-marm -O2 -pedantic -fomit-frame-pointer  -O2 -pipe -g -feliminate-unused-debug-types"
